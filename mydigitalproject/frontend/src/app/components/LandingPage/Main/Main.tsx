...
const Main = () => {
    return (
        <Box>
            <Box sx={{ display: "flex", alignItems: "center", padding: "40px 60px", gap: "30px" }}>
            ...
            <Box sx={{ width: "100%", p: "40px 60px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <Typography sx={{ fontFamily: "SFPRODISPLAY", fontSize: "35px", fontWeight: "bold" }}>Avec Meetwork, ouvrez votre horizon professionnel</Typography>
            </Box>
            <Box sx={{ display: "flex", alignItems: "center", gap: "118px", padding: "40px 60px", mb: "91px" }}>
                ...
                <Image src="/assets/images/illustration1.jpg" alt="illustration dream team" width={595} height={408} />
            </Box>

            {/* Box dégradée */}
            <Box sx={{ p: "40px 60px", height: "325px", background: "linear-gradient(180deg, #086AA6 0%, #06517F 100%)", display: "flex", justifyContent: "center", alignItems: "center", color: "white", gap: "90px", mb: "91px" }}>
                {/* premier bloc */}
            ...
            <Box sx={{ width: "100%", p: "20px 60px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <Typography sx={{ fontFamily: "SFPRODISPLAY", fontSize: "35px", fontWeight: "bold" }}>Mais, que vous propose Meetwork ?</Typography>
            </Box>
            <Box sx={{ display: "flex", alignItems: "center", gap: "118px", padding: "40px 60px", mb: "91px" }}>
                <Image src="/assets/images/illustration2.jpg" alt="illustration teamwork" width={595} height={397} />
                <Typography sx={{ fontFamily: "var(--font-montserrat)", fontSize: "20px" }}>
